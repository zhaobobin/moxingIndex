  ...
  render(){
    return(
      ...
      <div className={styles.sharemiddle}>
        <div className={styles.shareicon}><img src={require('../../assets/share/bask_goldcoin.png')} /><span>张**</span></div>
        <div className={styles.sharetip}>2018年回报</div>
        <div className={styles.sharemoney}><img src={require('../../assets/share/bask_goldcoin.png')} />204,580.32</div>
