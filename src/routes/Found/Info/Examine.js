  ...
  render(){
    return(
      <div className={styles.Examine}>
        ...
        <div className={styles.contentBox}>
          <a target="_blank" href="http://investtest.qutouwang.com/hyxd_qtw/customer_invest_info/pdf/audit_report.pdf">
        ...
        <div className={styles.contentBox}>
          <a target="_blank" href="http://investtest.qutouwang.com/hyxd_qtw/customer_invest_info/pdf/compliance_report_2018.pdf">
