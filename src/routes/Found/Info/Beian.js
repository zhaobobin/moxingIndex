      ...
      <div>
        <Information>
          <div className={styles.BeianBox}>
            ...
            <p
              className={styles.flow}>去投网风控部门经过对借款人信息进行综合判断、分析、比较和评价，完成风险评估流程后，最终出具审批意见。对于存在欺诈风险的申请，将第一时间反馈至反欺诈岗，进行反欺诈调查。反欺诈调查中确定存在欺诈行为的借款人，根据情况加入对应黑名单并按照相关法律法规进行上报。</p>
            <p>三、风险预警管理情况</p>
