    ...
    return (
      <div className={styles.YaoqingBox}>
        ...
        <div className={styles.YaoqingBoxTwo}>
          ...
          <div className={styles.YaoqingFooter}/>
        </div>

        <p className={styles.YaoqingFooterBox}>
          <img src={require("~/assets/Invitation/invent_app_bt1@2x.png")}
               onClick={() => this.redirect(ResultJson.invite_share.action)}/>
          <img
            src={require(isAuth === false ? "~/assets/Invitation/invent_app_bt3@2x.png" : '~/assets/Invitation/invent_app_bt2@2x.png')}
            onClick={() => this.redirect(isAuth === false ? ResultJson.invite_login.action : ResultJson.invite.action)}/>
        </p>
      </div>
    )
  }
