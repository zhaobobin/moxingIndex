...
export default class FormInit extends PureComponent {
  ...
  onValuesChange = (key) => {
    ...
    if(this.props.callback) this.props.callback({key, value})
  };
                ...
                <span className={styles.suffix}>
                  ...
                  <em className={styles.suffixText}>{topic.suffix ? topic.suffix : null}</em>
                  {
                    topic.checkPsdLevel && psdLevelVisible && form.getFieldValue(topic.key) ?
                      <div className={styles.psdStatus + " " + psdLevelStyle} style={topic.psdStatusStyle}>
      ...
      case 'RangePicker':
        html = <FormItem
          ...
          {form.getFieldDecorator(topic.key, {
            ...
            <RangePicker locale={locale} style={style} size="large" />
          )}
        </FormItem>;
        break;
        ...
        html = <FormItem {...btnItemLayout} className={styles.btnGroup}>
          {
            topic.btns.map((btn, k) => (
              <Button
                ...
                disabled={
                  ( btn.htmlType === 'submit' && hasErrors(form.getFieldsError()) )
                  ||
