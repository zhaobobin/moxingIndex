    ...
    props.colorBlu ?
      <div className={ styles.backBlueColor}>
          <div className={styles.imgBackground}>
            <a target="_blank" href="https://www.qutouwang.com/hyxd_qtw/customer_invest_info/pdf/Information_level_report_2018.pdf">
          ...
          <div className={styles.imgBackground}>
            <a target="_blank" href="https://www.qutouwang.com/hyxd_qtw/customer_invest_info/pdf/Information_level_report_2017.pdf">
